namespace ZodiacGlass.FFXIV
{
    ...
    {
        private static readonly Lazy<FFXIVMemoryMap> _default = new Lazy<FFXIVMemoryMap>(() => new FFXIVMemoryMap() { ItemSetPointer = new FFXIVPointer() { BaseAddressOffset = 0x010BC070, Offsets = new int[] { 0x60, 0x0 } } });
